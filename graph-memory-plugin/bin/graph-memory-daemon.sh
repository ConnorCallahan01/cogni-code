...
test -n "$ANTHROPIC_AUTH_TOKEN" && echo "  ANTHROPIC_AUTH_TOKEN: set (proxy/subscription)" || echo "  ANTHROPIC_AUTH_TOKEN: not set"
test -n "$ANTHROPIC_BASE_URL" && echo "  ANTHROPIC_BASE_URL: $ANTHROPIC_BASE_URL"
echo "CLI tools:"
