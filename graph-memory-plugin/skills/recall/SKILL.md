---
name: recall
description: Deep search memory graph with edge traversal and full node reading. Use when the user wants to search memory with multi-hop connections or needs detailed recall on a topic.
user_invocable: true
---
...
1. Take the user's query. If no query was provided, ask what topic to search for.
